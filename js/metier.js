...
import Fetch, { RESOURCES, BASE_SRV_URL } from './fetch.js';
// on n'est pas obligé de nommer la classe export default (on la nomme à l'import)
import name from './fetch.js';
